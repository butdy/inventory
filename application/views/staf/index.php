                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($mst_barang as $mb) : ?>
                                        <tr>
                                            ...
                                            <td> <a href="<?php echo base_url('gudang/edit_user/') . $mb['id_barang']; ?>" class="tombol-edit btn btn-info btn-block btn-sm" data-id="<?php echo $mb['id_barang']; ?>" data-toggle="modal" data-target="#edit-user"><i class="fas fa-plus"></i> &nbsp PERMINTAAN</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
...
<div class="modal fade" id="edit-user">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('staf/index'); ?>" method="post" id="form_id">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class=" form-group">
                                    <label for="kategori">Tgl Keluar</label>
                                    <input type="date" class="form-control form-control-sm" name="tgl_keluar" required>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class=" form-group">
                                    <label for="kategori">Permintaan Divisi</label>
                        ...
                        <div class=" form-group">
                            ...
                            <input type="text" class="form-control form-control-sm" name="penerima" required>
                        </div>
                        <div class=" form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <div class=" form-group">
                                    <label for="kat">Stock Keluar</label>
                                    <input type="text" class="form-control form-control-sm" name="jml_minta" id="txt1" onkeyup="sum();" required>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class=" form-group">
                        ...
                        <div class="box-footer">
                            <button type="submit" class="btn btn-primary pull-right">Simpan Stok Keluar</button>
