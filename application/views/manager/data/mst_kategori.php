            ...
            <div class="card card-primary card-outline">
                ...
                <div class="card">
                    <div class="card-header">
                        ...
                        <a href="<?php echo base_url('manager/mst_barang'); ?>" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#add-barang">
                            Tambah Barang
                        </a>
                    </div>
                    <div class="card-body">
                                ...
                                <tbody>
                                    ...
                                    <?php foreach ($mst_kategori as $mk) : ?>
                                        <tr>
                                            ...
                                            <td> <a href="<?php echo base_url('manager/edit_user/') . $mk['id_kategori']; ?>" class="tombol-edit btn btn-info btn-block btn-sm" data-id="<?php echo $mk['id_kategori']; ?>" data-toggle="modal" data-target="#edit-user">Edit</a></td>
                                            <td><a href="<?php echo base_url('manager/del_kategori/') . $mk['id_kategori']; ?>" class="tombol-hapus btn btn-danger btn-block btn-sm">Hapus</a> </td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('manager/mst_kategori'); ?>" method="post" id="form_id">
...
<div class="modal fade" id="edit-user">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('manager/edit_kategori'); ?>" method="post" id="form_id">
                        <div class="form-group">
                            <label for="kode">Kode Kategori</label>
...
<script>
    $('.tombol-edit').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo base_url('manager/get_edit_kategori'); ?>',
