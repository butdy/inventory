            ...
            <div class="row">
                ...
                <div class="col-md-4">
                    <div class="card card-primary card-outline">
                        ...
                        <div class="card-body">
                            <form role="form" action="<?php echo base_url('manager/list_jabatan'); ?>" method="post">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="box-body">
                    <form action="<?php echo base_url('manager/proses_edit_jabatan'); ?>" method="post" id="form_id">
                        <div class="form-group">
                            <label for="kdjab">Kode Jabatan</label>
...
<script>
    $('.tombol-edit').on('click', function() {
        ...
        $.ajax({
            url: '<?php echo base_url('manager/edit_jabatan'); ?>',
