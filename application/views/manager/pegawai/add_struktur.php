                ...
                <div class="col-md-6">
                    <div class="card card-primary card-outline">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <?php echo form_open_multipart('manager/add_struktur/' . $pegawai['kode_pegawai']); ?>
                        ...
                        <div class="card-body box-profile">
                            <ul class="list-group list-group-unbordered mb-3">
                                ...
                                <?php foreach ($history as $a) : ?>
                                    <li class="list-group-item">
                                        <a href="<?php echo base_url('manager/del_struktur/' . $a['id_struktural']); ?>" class="tombol-hapus btn btn-danger btn-xs"><i class="fas fa-trash-alt"></i></a> | <?php echo format_indo($a['tgl_input']); ?> | <?php echo $a['divisi']; ?><a class="float-right"><?php echo $a['jabatan']; ?></a>
                                    </li>
                                <?php endforeach; ?>
                            </ul>
                        </div>
